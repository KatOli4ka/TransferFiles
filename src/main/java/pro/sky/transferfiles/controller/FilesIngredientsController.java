...
public class FilesIngredientsController {
    ...
    @Operation(summary = "downloadIngredientsFile", description = "Скачивание файла с ингредиентами")
    @ApiResponses({
    ...
    @Operation(summary = "uploadIngredientsFile", description = "Загрузка файла с ингредиентами")
    @ApiResponses({
